...
def train(model, selected_embeddings):
  ...
  # init roberta
  # modified to modern stack
  if selected_embeddings['roberta']:
    embedding_types.append(TransformerWordEmbeddings('roberta-base'))
...
# modified - all left out, moved to main section; changed to defaultdict
...
# model = 'AMT'
# selected_embeddings = defaultdict(lambda: 0, {'glove':1, 'char':0, 'flair':0, 'pooled-flair':1})
# train(model, selected_embeddings)
